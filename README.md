...
HTTP API wrapping `@ai-native-solutions/falldental-us-sdk`.
...
- **Discoverable** — indexed on the FallMarket catalog at [sjgant80-hub.github.io/fallmarket/listing.html?id=falldental-us-api](https://sjgant80-hub.github.io/fallmarket/listing.html?id=falldental-us-api)
...
- **Companion SDK** (`npm install @ai-native-solutions/falldental-us-api-sdk`) — programmatic JavaScript API for direct integration.
- **Companion MCP server** (`claude mcp add falldental-us-api -- npx -y @ai-native-solutions/falldental-us-api-mcp`) — Model Context Protocol server that any Claude/Cursor/Codex client can invoke as a tool.
- **Companion HTTP API** (`docker run --rm ghcr.io/sjgant80-hub/falldental-us-api-api`) — containerized REST endpoint for language-agnostic access.
...
- **Registry entry**: https://sjgant80-hub.github.io/fallmarket/listing.html?id=falldental-us-api
- **Live URL**: https://sjgant80-hub.github.io/falldental-us-api/
- **Source**: https://github.com/sjgant80-hub/falldental-us-api
